...
import {UiKitSliderService} from './ui-kit-slider.service';
import {IDataDate} from './IDataDate';
...
export const MAT_SLIDER_VALUE_ACCESSOR: any = {
  ...
  useExisting: forwardRef(() => UiKitSliderComponent),
  multi: true
};
 ...
 */
@Component({
  selector: 'lib-ui-kit-slider',
  templateUrl: './ui-kit-slider.html',
  styleUrls: ['./ui-kit-slider.components.scss'],
  exportAs: 'libUiKitSlider',
...
export class UiKitSliderComponent extends _MatSliderMixinBase
  implements ControlValueAccessor, OnDestroy, CanDisable, CanColor, AfterViewInit, HasTabIndex, OnInit {
  ...
  constructor(elementRef: ElementRef,
              private sliderService: UiKitSliderService,
  ...
  @Input() dataDates: Array<IDataDate>;
  public year: number;
  public month: number;

  public date: Date;
  public boundariesYears: IBoundaries;
